...
public class GameCenterBinding
{
	...
	[DllImport("__Internal")]
	private static extern void _gameCenterRetrieveScoresForPlayerIdAndLeaderboardScope(string playerId, string leaderboardId, bool allTime, bool friendsOnly);

	public static void retrieveScoresForPlayerId(string playerId, string leaderboardId, bool allTime, bool friendsOnly)
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
		{
			_gameCenterRetrieveScoresForPlayerIdAndLeaderboardScope(playerId, leaderboardId, allTime, friendsOnly);
		}
	}
