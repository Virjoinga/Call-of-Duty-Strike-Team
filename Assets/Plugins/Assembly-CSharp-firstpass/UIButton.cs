...
public class UIButton : AutoSpriteControlBase
{
	...
	public override void OnInput(ref POINTER_INFO ptr)
	{
		...
		else if (ptr.evt != whenToInvoke && (whenToInvoke != POINTER_INFO.INPUT_EVENT.RELEASE || (ptr.evt != POINTER_INFO.INPUT_EVENT.TAP && ptr.evt != POINTER_INFO.INPUT_EVENT.RELEASE)))
		{
			return;
		}
