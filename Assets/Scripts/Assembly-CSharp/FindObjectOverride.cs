...
public class FindObjectOverride : ContainerOverride
{
	public MissionObjectiveData m_OverrideData = new MissionObjectiveData();

	public DiscoverableObjectData m_DiscoverableOverrideData = new DiscoverableObjectData();
	...
	public override void ApplyOverride(Container cont)
	{
		...
		DiscoverableObjectObjective discoverableObjectObjective = cont.FindComponentOfType(typeof(DiscoverableObjectObjective)) as DiscoverableObjectObjective;
		if (discoverableObjectObjective != null)
		{
			discoverableObjectObjective.m_Interface = m_OverrideData;
			discoverableObjectObjective.m_DiscoverableInterface = m_DiscoverableOverrideData;
			m_OverrideData.CopyContainerObjectives(discoverableObjectObjective);
		}
	}
	...
	public override void HookUpVisibleConnections(Container cont)
	{
		...
		if (m_DiscoverableOverrideData.ObjectsToFind == null || m_DiscoverableOverrideData.ObjectsToFind.Count == 0)
		{
			return;
		}
		foreach (GameObject item7 in m_DiscoverableOverrideData.ObjectsToFind)
		{
