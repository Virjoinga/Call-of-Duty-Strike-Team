...
public class HackTerminalObjectiveOverride : ContainerOverride
{
	public MissionObjectiveData m_OverrideData = new MissionObjectiveData();

	public HackObjectiveData m_HackOverrideData = new HackObjectiveData();
	...
	public override void ApplyOverride(Container cont)
	{
		...
		HackObjective hackObjective = cont.FindComponentOfType(typeof(HackObjective)) as HackObjective;
		if (hackObjective != null)
		{
			hackObjective.m_Interface = m_OverrideData;
			hackObjective.m_hackInterface = m_HackOverrideData;
			m_OverrideData.CopyContainerObjectives(hackObjective);
			m_HackOverrideData.CopyContainerData(hackObjective);
		}
	}
	...
	public override void HookUpVisibleConnections(Container cont)
	{
		...
		if (m_HackOverrideData.ContainerTerminal != null)
		{
			LineFlag inFlag5 = LineFlag.In;
			Transform inTrans5 = m_HackOverrideData.ContainerTerminal.GetBagGameObject().transform;
