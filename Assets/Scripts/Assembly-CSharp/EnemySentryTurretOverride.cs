...
public class EnemySentryTurretOverride : ContainerOverride
{
	...
	public override void SendOverrideMessage(GameObject gameObj, string methodName)
	{
		...
		if (methodName == "EnableInteraction" || methodName == "DisableInteraction")
		{
			CMHackableObjectSentryGun componentInChildren2 = componentInChildren.spawned.GetComponentInChildren<CMHackableObjectSentryGun>();
			if (componentInChildren2 != null)
			{
				if (methodName == "EnableInteraction")
				{
					componentInChildren2.EnableInteraction();
				}
				else
				{
					componentInChildren2.DisableInteraction();
				}
			}
		}
		else
