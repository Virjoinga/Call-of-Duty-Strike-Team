...
internal class Weapon_AN94 : IWeapon, IWeaponADS, IWeaponAI, IWeaponStats
{
	private WeaponDescriptor_AN94 mDescriptor;
	...
	public Weapon_AN94(WeaponDescriptor_AN94 descriptor, GameObject model, float adsModifier, float ammoModifier, float reloadModifier)
	{
	...
	private bool TryToFire(BaseCharacter owner, Vector3 position, Vector3 target)
	{
		...
		if (owner != null)
		{
			...
			{
				WeaponSFX.Instance.AN94Fire.Play(owner.gameObject);
			}
			else
			{
				WeaponSFX.Instance.AN94Fire.Play(owner.gameObject, m_AudioFilter);
			}
		}
	...
	public float PlayReloadSfxFP(float oldTimeInAnim, float newTimeInAnim, float[,] eventTimes, ref int whichEvent)
	{
		...
		if (eventToPlay != -1 && GameController.Instance.mFirstPersonActor != null)
		{
			...
			if (IsTacticalReload())
			{
				...
				{
				case 0:
					WeaponSFX.Instance.AN94MagOut.Play(gameObject);
					break;
				case 1:
					WeaponSFX.Instance.AN94MagIn.Play(gameObject);
					break;
				}
			}
			else
			{
				...
				case 1:
					...
					break;
				case 2:
					WeaponSFX.Instance.AN94ChargeBack.Play(gameObject);
					break;
				case 3:
					WeaponSFX.Instance.AN94ChargeForward.Play(gameObject);
					break;
				}
			}
		}
