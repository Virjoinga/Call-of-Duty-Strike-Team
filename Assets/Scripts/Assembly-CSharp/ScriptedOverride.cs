...
public class ScriptedOverride : ContainerOverride
{
	...
	public override void ApplyOverride(Container cont)
	{
		...
		ScriptedObjective scriptedObjective = cont.FindComponentOfType(typeof(ScriptedObjective)) as ScriptedObjective;
		if (scriptedObjective != null)
		{
			scriptedObjective.m_Interface = m_OverrideData;
			m_OverrideData.CopyContainerObjectives(scriptedObjective);
		}
	}
	...
	public override void SendOverrideMessage(GameObject gameObj, string methodName)
	{
		...
		ScriptedObjective componentInChildren = gameObj.GetComponentInChildren<ScriptedObjective>();
