...
public class EnemySecurityCameraOverride : ContainerOverride
{
	public SpawnerData m_SpawnerOverrideData = new SpawnerData();

	public SecurityCameraOverrideData m_CameraOverrideData = new SecurityCameraOverrideData();
	...
	public override void ApplyOverride(Container cont)
	{
		...
		if (spawner != null)
		{
			...
			spawner.m_CameraOverrides = m_CameraOverrideData;
		}
	}
