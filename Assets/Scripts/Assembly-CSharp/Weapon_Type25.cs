...
internal class Weapon_Type25 : IWeapon, IWeaponADS, IWeaponAI, IWeaponStats
{
	private WeaponDescriptor_Type25 mDescriptor;
	...
	public Weapon_Type25(WeaponDescriptor_Type25 descriptor, GameObject model, float adsModifier, float ammoModifier, float reloadModifier)
	{
	...
	private bool TryToFire(BaseCharacter owner, Vector3 position, Vector3 target)
	{
		...
		if (owner != null)
		{
			WeaponSFX.Instance.Type25Fire.Play(owner.gameObject);
		}
	...
	public float PlayReloadSfxFP(float oldTimeInAnim, float newTimeInAnim, float[,] eventTimes, ref int whichEvent)
	{
		...
		if (eventToPlay != -1 && GameController.Instance.mFirstPersonActor != null)
		{
			...
			if (IsTacticalReload())
			{
				...
				{
				case 0:
					WeaponSFX.Instance.Type25MagOut.Play(gameObject);
					break;
				case 1:
					WeaponSFX.Instance.Type25MagIn.Play(gameObject);
					break;
				}
			}
			else
			{
				...
				case 1:
					...
					break;
				case 2:
					WeaponSFX.Instance.Type25ChargeBack.Play(gameObject);
					break;
				case 3:
					WeaponSFX.Instance.Type25ChargeForward.Play(gameObject);
					break;
				}
			}
		}
