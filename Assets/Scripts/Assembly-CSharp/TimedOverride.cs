...
public class TimedOverride : ContainerOverride
{
	public MissionObjectiveData m_OverrideData = new MissionObjectiveData();

	public TimedData m_OverrideTimedData = new TimedData();
	...
	public override void ApplyOverride(Container cont)
	{
		...
		TimerObjective timerObjective = cont.FindComponentOfType(typeof(TimerObjective)) as TimerObjective;
		if (timerObjective != null)
		{
			timerObjective.m_Interface = m_OverrideData;
			timerObjective.m_TimedInterface = m_OverrideTimedData;
			m_OverrideData.CopyContainerObjectives(timerObjective);
		}
	}
