...
public class StayAliveOnMiniGunOverride : ContainerOverride
{
	...
	public override void ApplyOverride(Container cont)
	{
		...
		StayAliveOnMiniGunObjective stayAliveOnMiniGunObjective = cont.FindComponentOfType(typeof(StayAliveOnMiniGunObjective)) as StayAliveOnMiniGunObjective;
		if (stayAliveOnMiniGunObjective != null)
		{
			stayAliveOnMiniGunObjective.m_Interface = m_OverrideData;
			m_OverrideData.CopyContainerObjectives(stayAliveOnMiniGunObjective);
		}
	}
