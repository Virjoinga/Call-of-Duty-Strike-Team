...
public class AlarmTrippedOverride : ContainerOverride
{
	...
	public override void ApplyOverride(Container cont)
	{
		...
		AlarmSetOffObjective alarmSetOffObjective = cont.FindComponentOfType(typeof(AlarmSetOffObjective)) as AlarmSetOffObjective;
		if (alarmSetOffObjective != null)
		{
			alarmSetOffObjective.m_Interface = m_OverrideData;
			m_OverrideData.CopyContainerObjectives(alarmSetOffObjective);
			return;
		}
		EnemyAlertedObjective enemyAlertedObjective = cont.FindComponentOfType(typeof(EnemyAlertedObjective)) as EnemyAlertedObjective;
		if (enemyAlertedObjective != null)
		{
			enemyAlertedObjective.m_Interface = m_OverrideData;
			m_OverrideData.CopyContainerObjectives(enemyAlertedObjective);
		}
	}
