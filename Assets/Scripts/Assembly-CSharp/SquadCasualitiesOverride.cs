...
public class SquadCasualitiesOverride : ContainerOverride
{
	public MissionObjectiveData m_OverrideData = new MissionObjectiveData();

	public int OverrideMaxPlayerCasualties = 4;
	...
	public override void ApplyOverride(Container cont)
	{
		...
		SquadCasualtiesObjective squadCasualtiesObjective = cont.FindComponentOfType(typeof(SquadCasualtiesObjective)) as SquadCasualtiesObjective;
		if (squadCasualtiesObjective != null)
		{
			squadCasualtiesObjective.m_Interface = m_OverrideData;
			squadCasualtiesObjective.MaxPlayerCasualties = OverrideMaxPlayerCasualties;
			m_OverrideData.CopyContainerObjectives(squadCasualtiesObjective);
		}
	}
