...
public class EvadeCamerasOverride : ContainerOverride
{
	...
	public override void ApplyOverride(Container cont)
	{
		...
		EvadeCamerasObjective evadeCamerasObjective = cont.FindComponentOfType(typeof(EvadeCamerasObjective)) as EvadeCamerasObjective;
		if (evadeCamerasObjective != null)
		{
			evadeCamerasObjective.m_Interface = m_OverrideData;
			m_OverrideData.CopyContainerObjectives(evadeCamerasObjective);
		}
	}
