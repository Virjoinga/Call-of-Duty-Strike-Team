ŠVShader "Hidden/MinimalLightmapVertexAlpha" {
Properties {
...
void main() {
    ...
    xlv_TEXCOORD2 = float(xl_retval.alpha);
}
...
lowp vec4 frag( in v2f i ) {
    ...
    return vec4( (vec3( texture( _MainTex, i.uv1)) * lm), i.alpha);
}
...
void main() {
    ...
    xlt_i.alpha = float(xlv_TEXCOORD2);
