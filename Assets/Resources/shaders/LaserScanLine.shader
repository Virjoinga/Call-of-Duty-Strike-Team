—LShader "Corona/Effects/LaserScanLine" {
Properties {
...
void main ()
{
  ...
  highp vec2 tmpvar_5;
  tmpvar_5 = ((_Object2World * _glesVertex).xz * 0.1);
  tmpvar_1 = tmpvar_5;
...
v2f vert( in appdata_full v ) {
    ...
    #line 395
    o.uv1.xy = ((_Object2World * v.vertex).xz * 0.1);
    o.uv1.y -= _Scroll;
    o.col = v.color;
    return o;
}
...
lowp vec4 frag( in v2f i ) {
    return (texture( _MainTex, i.uv1) * i.col);
}
