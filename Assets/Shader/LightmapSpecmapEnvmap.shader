    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t v)
            {
                ...
                o.texcoord4 = tmpvar_6;
                o.texcoord5 = tmpvar_7;
                return o;
            }
            float4 frag(v2f i) : SV_TARGET
            {
                ...
                float spec_7;
                float tmpvar_8;
                tmpvar_8 = max (0.0, dot (normalize((lightDir_2 + normalize(i.texcoord2))), normalize(i.texcoord3)));
                spec_7 = tmpvar_8;
                float tmpvar_9;
                ...
                float4 tmpvar_10;
                tmpvar_10.w = 1.0;
                tmpvar_10.xyz = (((((tex2D (_MainTex, i.texcoord0).xyz + (tmpvar_6.xxx * tmpvar_1.xyz)) * UNITY_SAMPLE_TEX2D (unity_Lightmap, i.texcoord1).xyz) + ((texCUBE (_ThemedCube, i.texcoord4).xyz * (_Reflectivity * 0.5)) * tmpvar_1.xyz)) * i.texcoord5.w) + i.texcoord5.xyz);
                return tmpvar_10;
            }
            ENDCG
        }
