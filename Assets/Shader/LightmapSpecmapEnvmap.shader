•ðShader "Corona/Lightmap/[Spec] [Env]" {
Properties {
...
void main ()
{
  ...
  tmpvar_14 = ((_World2Object * tmpvar_13).xyz - _glesVertex.xyz);
  highp vec3 i_15;
  i_15 = -(tmpvar_14);
...
void main ()
{
  ...
  lowp vec4 tmpvar_10;
  tmpvar_10.w = 1.0;
  tmpvar_10.xyz = (((((texture2D (_MainTex, xlv_TEXCOORD0).xyz + (vec3(tmpvar_6) * tmpvar_1.xyz)) * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz) + ((textureCube (_ThemedCube, xlv_TEXCOORD4).xyz * (_Reflectivity * 0.5)) * tmpvar_1.xyz)) * xlv_TEXCOORD5.w) + xlv_TEXCOORD5.xyz);
