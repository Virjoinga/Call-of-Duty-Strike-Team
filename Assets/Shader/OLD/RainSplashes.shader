    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t v)
            {
                ...
                float2 tmpvar_8;
                tmpvar_8 = ((v.texcoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
                tmpvar_1 = tmpvar_8;
                float2 tmpvar_9;
                tmpvar_9 = frac((_Time.y * _RippleSpeed));
                tmpvar_2 = tmpvar_9;
                float2 tmpvar_10;
                tmpvar_10 = ((v.texcoord0.xy * _Splashes_ST.xy) + _Splashes_ST.zw);
                tmpvar_3 = tmpvar_10;
                float2 tmpvar_11;
                tmpvar_11 = ((v.texcoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
                tmpvar_4 = tmpvar_11;
                o.vertex = tmpvar_7;
            ...
            {
                float4 tmpvar_1;
                tmpvar_1 = tex2D (_Splashes, i.texcoord2);
                float2 P_2;
                P_2 = (i.texcoord1 + tmpvar_1.xy);
                float4 tmpvar_3;
                tmpvar_3.xyz = (2.0 * UNITY_SAMPLE_TEX2D (unity_Lightmap, i.texcoord3).xyz);
                tmpvar_3.w = (tex2D (_MainTex, i.texcoord0).x * dot (tex2D (_Ripples, P_2).xy, tmpvar_1.zw));
                return tmpvar_3;
            }
            ENDCG
        }
