...
void main() {
    ...
    xlv_COLOR0 = vec4(xl_retval.colour);
...
lowp vec4 frag( in v2f i ) {
    lowp vec3 rgb = texture( _MainTex, i.uv).xyz;
    lowp float a = texture( _AlphaTex, i.uv).x;
    #line 343
    lowp vec4 o = (vec4( rgb, a) * i.colour);
    return o;
}
