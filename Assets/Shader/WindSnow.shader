²MShader "Corona/Effects/WindSnow" {
Properties {
...
uniform mediump vec3 g_windSnowData;
...
void main ()
{
  ...
  tmpvar_6 = (_glesMultiTexCoord0.x - dot (g_windSnowData, _glesColor.xyz));
  tmpvar_1.x = tmpvar_6;
  highp float tmpvar_7;
  tmpvar_7 = _glesMultiTexCoord0.y;
  tmpvar_1.y = tmpvar_7;
...
uniform lowp vec3 g_windSnowColour;
void main ()
{
  lowp vec4 colour_1;
  colour_1.xyz = g_windSnowColour;
  colour_1.w = (texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR).x;
...
v2f vert( in appdata_t v ) {
    ...
    #line 403
    o.texCoord.x = (v.texCoord.x - dot( g_windSnowData.xyz, v.color.xyz));
...
lowp vec4 frag( in v2f i ) {
    lowp vec4 texAlpha = texture( _MainTex, i.texCoord);
    lowp vec4 colour;
    #line 412
    colour.xyz = g_windSnowColour;
    colour.w = (texAlpha * i.alpha).x;
    return colour;
}
