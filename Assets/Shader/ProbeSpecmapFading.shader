Ö÷Shader "Hidden/ProbeSpecmapFading" {
Properties {
...
void main ()
{
  ...
  tmpvar_13 = normalize(((_World2Object * tmpvar_10).xyz - _glesVertex.xyz));
  tmpvar_4 = tmpvar_13;
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9.xyz = ((((texture2D (_MainTex, xlv_TEXCOORD0).xyz + (vec3(tmpvar_5) * texture2D (_SpecMap, xlv_TEXCOORD0).xyz)) * xlv_TEXCOORD1) * xlv_TEXCOORD5.w) + xlv_TEXCOORD5.xyz);
  tmpvar_9.w = _Opacity;
