Shader "Hidden/ProbeNormalmapSpecmapEnvmap NoFogFading" {
Properties {
...
void main ()
{
  ...
  tmpvar_22 = (((tmpvar_2.yzx * tmpvar_1.zxy) - (tmpvar_2.zxy * tmpvar_1.yzx)) * _glesTANGENT.w);
...
void main ()
{
  ...
  tmpvar_2 = tmpvar_5;
  lowp vec4 tmpvar_6;
  tmpvar_6.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0).xyz + (vec3(tmpvar_2) * tmpvar_1.xyz)) * xlv_TEXCOORD1.xyz) + ((textureCube (_ThemedCube, xlv_TEXCOORD4).xyz * _Reflectivity) * tmpvar_1.xyz));
  tmpvar_6.w = _Opacity;
...
void main ()
{
  ...
  tmpvar_11 = normalize((_Object2World * tmpvar_10).xyz);
  highp vec3 i_12;
  i_12 = (_glesVertex.xyz - (_World2Object * tmpvar_9).xyz);
  highp vec4 tmpvar_13;
  tmpvar_13.w = 0.0;
  tmpvar_13.xyz = (i_12 - (2.0 * (dot (tmpvar_1, i_12) * tmpvar_1)));
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0).xyz * xlv_TEXCOORD1) + (textureCube (_ThemedCube, xlv_TEXCOORD4).xyz * _Reflectivity));
  tmpvar_1.w = _Opacity;
