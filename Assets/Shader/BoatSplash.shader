ùMShader "Corona/Effects/BoatSplash" {
Properties {
...
void main ()
{
  ...
  xlv_TEXCOORD1 = (_TintColor * _glesColor);
}
...
void main() {
    ...
    xlv_TEXCOORD1 = vec4(xl_retval.colour);
}
...
lowp vec4 frag( in v2f i ) {
    return (texture( _MainTex, i.uv.xy) * i.colour);
}
...
void main() {
    ...
    xlt_i.colour = vec4(xlv_TEXCOORD1);
